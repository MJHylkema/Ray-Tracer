...
const Color Color::LIGHTBLUE = Color(0, 0, 0.5f);
const Color Color::YELLOW = Color(1,1,0);
const Color Color::LIGHTYELLOW = Color(0.4f, 0.4f, 0);
const Color Color::GRAY = Color(0.2f, 0.2f, 0.2f);
const Color Color::PURPLE = Color(0.6f, 0, 0.6f);
const Color Color::LIGHTPURPLE = Color(0.8f,0.8f,0.8f);
const Color Color::ORANGE = Color(1, 0.25f, 0);
